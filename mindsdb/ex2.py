...
engine = create_engine('postgresql://postgres:postgres@localhost:5432/mindsdb')
...
# Connect to MindsDB
mdb = mindsdb.Predictor(name='product_review_predictor')
...
print(predictions[['review_text', 'rating', 'predicted_rating']])
...
print(new_review_prediction[['review_text', 'predicted_rating']])
